...
typedef enum
{
  CK_GPIO_INPUT                 = GPIO_MODE_INPUT,
  CK_GPIO_OUTPUT_PP             = GPIO_MODE_OUTPUT_PP,
  CK_GPIO_OUTPUT_OD             = GPIO_MODE_OUTPUT_OD,
  CK_GPIO_AF_PP               	= GPIO_MODE_AF_PP,
  CK_GPIO_AF_OD              	= GPIO_MODE_AF_OD,
  CK_GPIO_ANALOG                = GPIO_MODE_ANALOG
